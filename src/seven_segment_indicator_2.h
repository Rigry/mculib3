...
template<class A, class B, class C, class D, class E, class F, class G, class H, class K1, class K2, class K3, class K4, class K5, class K6>
...
private:
   ...
   static constexpr uint8_t qty {6};
   ...
   std::array<Pin, qty> k {
      ...
      Pin::make<K3, mcu::PinMode::Output>(),
      Pin::make<K4, mcu::PinMode::Output>(),
      Pin::make<K5, mcu::PinMode::Output>(),
      Pin::make<K6, mcu::PinMode::Output>()
   };
